...
PRODUCT_DETAIL_COLORCHANGE = 0x0102  # Semaphore or other universe_type
...
DS_NOT_DEFINED = 0x00  # Data universe_type is not defined
...
ST_SEC_UNDEFINED = 0xFF  # Undefined secondary universe_type
